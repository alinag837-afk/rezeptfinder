...
(function () {
  ...
  const oldCloudLaden166 = typeof cloudLaden === "function" ? cloudLaden : null;
  if (oldCloudLaden166) {
    cloudLaden = async function () {
      const res = await oldCloudLaden166.apply(this, arguments);
      rf166PruneLocal();
      return res;
    };
    window.cloudLaden = cloudLaden;
  ...
  const oldCloudHerunterladen166 = typeof cloudHerunterladen === "function" ? cloudHerunterladen : null;
  if (oldCloudHerunterladen166) {
    cloudHerunterladen = async function () {
      const res = await oldCloudHerunterladen166.apply(this, arguments);
      rf166PruneLocal();
      return res;
    };
    window.cloudHerunterladen = cloudHerunterladen;
